...
uint256 hashGenesisBlock("0x0000728676f217086dea1c5d2a3ba851e665c2d6ee0de0dd35042768f4859542");
...
int64 nChainStartTime = 1490477859;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "This is your chance to get in at the very beginning of what could prove to be very special investments";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 182617 : 182617;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x7f71131151a250124567915abbc2e532f38341a0b44c47844d389b6100d8bb087c9cfb"));
...
unsigned char pchMessageStart[4] = { 0x2e, 0xab, 0xb5, 0xd3 };
